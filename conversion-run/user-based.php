            ...
            <div class="row">
                <div class="col-lg-1 col-md-2 col-sm-2 col-2">
                    <div class="main-icons-box">
                        <a href="home.php"><img src="../assets/img/image/data.png" class="icon icon1" /></a>
                        <a href="user-based.php"><img src="../assets/img/image/wpe.png" class="icon icon2" style="background-color: #105A71;" /></a>
                ...
                <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                    ...
                    <div class="employee-training-assessment-box">
                        <div class="row">
                                ...
                                <div class="training-box">
                                    ...
                                    <div class="white-box">
                                        <div class="row">
                                            ...
                                            <div class="box-rates-wt">
                                                    <p class="color19 fs14 fpw6">Training Status</p>
                                                    <h3 class="color20">Completed</h3>
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                            ...
                            <div class="col-lg-6 p-1">
                                <div class="training-box">
                                    <h4 class="heading">Quiz Section</h4>
                                    <div class="white-box">
                                        <div class="row">
                                            <div class="col-xl-5 col-lg-7">
                                                <div class="box-rates-wt">
                                            ...
                                            <div class="box-rates-wt">
                                                    <p class="color19 fs14 fpw6">Quiz status</p>
                                                    <h3 class="color20">Failed</h3>
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="slection-option">
