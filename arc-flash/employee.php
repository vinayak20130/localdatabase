                        ...
                        <div class="row">
                            <div class="col-lg-6 p-1">
                                <div class="training-box">
                                    ...
                                    <div class="white-box">
                                        <div class="row">
                                            <div class="col-xl-5 col-lg-7 col-sm-5">
                                            ...
                                            <div class="col-xl-5 col-lg-1 col-sm-5">
                                                <div class="box-rates-wt">
                                                ...
                                                <?php
                                                    ...
                                                    if ($sessionResult) {
                                                        ...
                                                        while ($sessionRow = mysqli_fetch_assoc($sessionResult)) {
                                                            ...
                                                            echo "<option value='$trainingTime, $statusTime'>Session $i</option>";
                                                        }
                                                        }
                                ...
                                <div class="training-box">
                                    ...
                                    <div class="white-box">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-5 col-lg-2 col-sm-5">
                                                <div class="box-rates-wt">
